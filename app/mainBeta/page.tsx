...
import { ShowPersonData,GetPersonDataWithSearch } from '../main/action';
import DeletePersonData from '@/app/DeleteAllPersonData';
import SearchPerson from '../main/searchPerson';
...
export default async function Page(props: {searchParams: Promise<{query?: string}>}) {
  ...
  return (
    <div className="flex flex-col justify-center items-center m-10 gap-5">
      ...
      <h1 className="font-bold text-3xl">ระบบค้นหาข้อมูลคนหายด้วยรูปภาพ</h1>
